...
%-------
\begin{document}
\cvheader{Iggy}{ de Villiers}{Senior Software Engineer (MEng)} % Your name and current job title/field
%----------------------------------------------------------------------------------------
%	SIDEBAR SECTION
%----------------------------------------------------------------------------------------
...
\textbf{Content Platform Team:}
As a member of the Content Platform team, I'm architecting the next generation of CF's content platform. The project involves migrating and transforming millions of existing products from complex and convoluted legacy systems, while staying up to date with any updates, and creating a highly efficient content platform to serve every single aspect of content action across CF's entire domain.
